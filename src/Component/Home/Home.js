    ...
    return (
        <div className='md:px-16 py-8'>
            <div className='grid items-center w-full grid-cols-1 gap-10 mx-auto md:w-4/5 lg:grid-cols-2 xl:gap-32'>
                <div>
                    <h1 className='mb-4 text-2xl font-extrabold leading-tight tracking-tight text-left text-blue-900 md:text-4xl'>
            ...
            <div>
                <h1 className='mt-40 mb-24 text-2xl font-extrabold leading-tight tracking-tight text-blue-900 md:text-4xl text-center'>Customer Review</h1>
            </div>
